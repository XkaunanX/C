...
// Funcion para insertar un nodo en orden
void insertar_nodo_ordenado(Data dato, ListaEnlazada *punteros_lista)
{
    ...
    // Si la lista esta vacia o el valor del nuevo nodo es menor que el primer nodo
    if (punteros_lista->cabeza == NULL || punteros_lista->cabeza->Dato.valor > nuevo_nodo->Dato.valor) {
        ...
        // Buscar la posicion correcta donde insertar el nuevo nodo
